...
const DeleteForm = ({ setDelete }: { setDelete: React.Dispatch<React.SetStateAction<boolean>> }) => {
        ...
        <>
            ...
            <div className='absolute py-5 w-full max-w-sm  bg-white z-30 border rounded-lg top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                ...
                <CardContent className='space-y-2  mt-6'>
                    <Label htmlFor="command" className='block'>Type "{correctCommand}" below to continue.</Label>
                    <Input id="command" value={command} onChange={(e) => setCommand(e.target.value)} placeholder={correctCommand} required />
                </CardContent>
